...
import com.szu.SimpleORM.utils.JavaFileUtils;
import com.szu.SimpleORM.utils.StringUtils;
...
public class TableContext {
	...
	public static void updateJavaPOFile(){
		...
		TypeConvertor typeConvertor=TypeConvertorFactory.getTypeConvertor();
		for(TableInfo t:map.values()){
			JavaFileUtils.createJavaPOFile(t,typeConvertor);
		}	
	}
